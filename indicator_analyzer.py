...
Uses 'ta' library for calculating RSI, MACD, and other indicators
...
async def get_smart_tp(candles: list[dict]) -> Decimal:
    """
    Quick helper to get smart TP recommendation.
    
    Args:
        candles: Candle data from API
    ...
    if signal:
        logger.info(f"Smart TP: {signal.recommendation}")
